...
JSettlers[http://jsettlers.sf.net] project, and then the follow-on
JSettlers2[http://settler2.sf.net]. I just wrapped all their code with a handy
shell script, adding basic Bonjour support.
